...
namespace motor
{
    namespace platform
    {
        ...
        namespace es3
        {
                ...
                motor::graphics::image_element_type const t )
            {
                ...
                case motor::graphics::image_format::rgb:
                    switch( t )
                    {
                    case motor::graphics::image_element_type::uint8: return GL_RGB ;
                ...
                case motor::graphics::image_format::rgba:
                    switch( t )
                    {
                    case motor::graphics::image_element_type::uint8: return GL_RGBA ;
        ...
        namespace es3
        {
            ...
            {
                return motor::platform::es3::detail::texture_types_gl[ ( size_t ) m ] ;
            }

            static GLenum convert( motor::graphics::texture_filter_mode const m ) noexcept
            {
                return motor::platform::es3::detail::filter_modes_gl[ ( size_t ) m ] ;
            }

            static GLenum convert( motor::graphics::texture_filter_type const t ) noexcept
            {
                return motor::platform::es3::detail::filter_types_gl[ ( size_t ) t ] ;
            }
            ...
            static GLenum convert( motor::graphics::texture_wrap_mode const m ) noexcept {
                return motor::platform::es3::detail::wrap_modes_gl[ ( size_t ) m ] ;
            }

            static GLenum convert( motor::graphics::texture_wrap_type const t ) noexcept {
                return motor::platform::es3::detail::wrap_types_gl[ ( size_t ) t ] ;
            }
