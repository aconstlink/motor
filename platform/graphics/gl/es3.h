...
namespace motor { namespace platform { namespace gen4 {

    class MOTOR_PLATFORM_API es3_backend : public motor::graphics::gen4::backend
    {
    ...
    private:
        ...
        motor::platform::opengl_es::rendering_context_ptr_t _context = nullptr ;

    public:

        es3_backend( motor::platform::opengl_es::rendering_context_ptr_t ) noexcept ;
        es3_backend( this_cref_t ) = delete ;
        es3_backend( this_rref_t ) noexcept ;
        virtual ~es3_backend( void_t ) noexcept ;
