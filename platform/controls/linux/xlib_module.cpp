...
xlib_module::xlib_module( void_t ) 
{
    ...
    {
        _three_device = motor::memory::create_ptr( motor::controls::three_device_t( "Xlib Three Button Mouse" ),
            "[xlib_module] : three button mouse" );
        _ascii_device = motor::memory::create_ptr( motor::controls::ascii_device_t( "Xlib Ascii Keyboard" ),
...
//************************************************************
void_t xlib_module::search( motor::controls::imodule::search_funk_t funk ) noexcept
{
    funk( ( _three_device ) ) ;
    funk( ( _ascii_device ) ) ;
}
...
void_t xlib_module::update( void_t ) noexcept
{
    ...
    // mouse
    {
        ...
        // insert new events
        {
            ...
            {
                auto* coord = mouse.get_global_component() ;
                *coord = motor::controls::components::move_state::unmoved ;
            }
    ...
    // keybaord
    {
        ...
        
        {
            ...
            {
                float_t const value = item.second != motor::controls::components::key_state::released ? 1.0f : 0.0f ;
...
{
    auto bs = motor::controls::components::button_state::none ;
    auto ks = motor::controls::components::key_state::none ;
    ...
    case ButtonPress:
        bs = motor::controls::components::button_state::pressed ;
        break ;

    case ButtonRelease:
        bs = motor::controls::components::button_state::released ;
        break ;

    case KeyPress:
        ks = motor::controls::components::key_state::pressed ;
        break ;

    case KeyRelease:
        ks = motor::controls::components::key_state::released ;
        break ;
    }
