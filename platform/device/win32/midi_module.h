...
#include <motor/device/midi_message.hpp>
...
namespace motor
{
    namespace platform
    {
        namespace win32
        {
            class MOTOR_PLATFORM_API midi_module : public motor::device::imodule
            {
            ...
            private: // midi devices
                ...
                struct device_data
                {
                    ...
                    motor::string_t name ;
                    motor::device::midi_device_mtr_t dev_ptr ;
            ...
            private: // messages
                ...
                {
                    HMIDIIN inh ;
                    motor::device::midi_message message ;
                };
