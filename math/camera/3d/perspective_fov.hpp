...
struct perspective
{
  ...
  public:
    ...
    static void_t create_by_fov(
        vec2_cref_t const fov, type_t const n, type_t const f, mat4_out_t m )
    {
    ...
    /// by horizontal fov
    static void_t create_by_fovh_aspect(
        type_t const fov, type_t const aspect, type_t const n, type_t const f, mat4_out_t m )
    {
...
#else
    /// by vertical fov
    static void_t create_by_fovv_aspect(
        type_t const fov, type_t const aspect, type_t const n, type_t const f, mat4_out_t m )
    {
...
void create_perspective_projection_matrix(
    type_t width, type_t height, type_t n, type_t f, motor::math::matrix4< type_t > & inout )
{
...
*/
template < typename type_t >
void create_perspective_projection_matrix_fov(
    type_t fov, type_t ar, type_t n, type_t f, motor::math::matrix4< type_t > & inout )
{
