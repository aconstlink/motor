...
class msl_bridge
{
  ...
  public:
    ...
    //**************************************************************************************************
    static motor::graphics::shader_object_t create_unknown_api_type(
        motor::msl::generated_code_cref_t code ) noexcept
    {
        ...
        // code
        {
            motor::vector< motor::msl::api_type > const types = {
                motor::msl::api_type::es3, motor::msl::api_type::gl4, motor::msl::api_type::d3d11 };
            ...
            for( auto const & t : types )
            {
                ...
                code.sorted_by_api_type( t,
                    [ & ]( motor::msl::shader_type st, motor::msl::generated_code_t::code_cref_t c )
                {
        ...
        motor::msl::generated_code_cref_t code ) noexcept
    {
        ...
        // vertex input bindings
        {
            for( auto const & v : code.geometry_ins )
            {
                // check texcoord
                {
                    if( motor::msl::is_texcoord( v.binding ) )
                    {
                        ...
                        case motor::msl::binding::texcoord0:
                            va = motor::graphics::vertex_attribute::texcoord0;
                            break;
                        case motor::msl::binding::texcoord1:
                            va = motor::graphics::vertex_attribute::texcoord1;
                            break;
                        case motor::msl::binding::texcoord2:
                            va = motor::graphics::vertex_attribute::texcoord2;
                            break;
                        case motor::msl::binding::texcoord3:
                            va = motor::graphics::vertex_attribute::texcoord3;
                            break;
                        case motor::msl::binding::texcoord4:
                            va = motor::graphics::vertex_attribute::texcoord4;
                            break;
                        case motor::msl::binding::texcoord5:
                            va = motor::graphics::vertex_attribute::texcoord5;
                            break;
                        case motor::msl::binding::texcoord6:
                            va = motor::graphics::vertex_attribute::texcoord6;
                            break;
                        case motor::msl::binding::texcoord7:
                            va = motor::graphics::vertex_attribute::texcoord7;
                            break;
                        default:
                            break;
                        }
                ...
                // check color
                {
                    if( motor::msl::is_color( v.binding ) )
                    {
                        ...
                        case motor::msl::binding::color0:
                            va = motor::graphics::vertex_attribute::color0;
                            break;
                        case motor::msl::binding::color1:
                            va = motor::graphics::vertex_attribute::color1;
                            break;
                        case motor::msl::binding::color2:
                            va = motor::graphics::vertex_attribute::color2;
                            break;
                        case motor::msl::binding::color3:
                            va = motor::graphics::vertex_attribute::color3;
                            break;
                        case motor::msl::binding::color4:
                            va = motor::graphics::vertex_attribute::color4;
                            break;
                        case motor::msl::binding::color5:
                            va = motor::graphics::vertex_attribute::color5;
                            break;
                        default:
                            break;
                        }
                ...
                {
                    sb.add_vertex_input_binding(
                        motor::graphics::vertex_attribute::position, v.name );
                }
                else if( v.binding == motor::msl::binding::normal )
                {
                    sb.add_vertex_input_binding(
                        motor::graphics::vertex_attribute::normal, v.name );
                }
                else if( v.binding == motor::msl::binding::tangent )
                {
                    sb.add_vertex_input_binding(
                        motor::graphics::vertex_attribute::tangent, v.name );
                }
            }
        }
        ...
        if( code.streamout != motor::msl::streamout_type::none )
        {
            ...
            {
            case motor::msl::streamout_type::interleaved:
                sm = motor::graphics::streamout_mode::interleaved;
                break;
            case motor::msl::streamout_type::separate:
                sm = motor::graphics::streamout_mode::separate;
                break;
            default:
                break;
            }
