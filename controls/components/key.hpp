...
namespace motor
{
    namespace controls
    {
        namespace components
        {
            ...
            static motor::string_t to_string( motor::controls::components::key_state const ks ) noexcept
            {
            ...
            private:
                ...
                motor::controls::components::key_state _s = motor::controls::components::key_state::none ;
                float_t _value = 0.0f ;
            ...
            public:
                ...
                {
                    _s = rhv._s ; rhv._s = motor::controls::components::key_state::none ;
                    _key_type = rhv._key_type ;
                    _value = rhv._value ;
                }
            ...
            public:
                ...
                motor::controls::components::key_state state( void_t ) const noexcept { return _s ; }
