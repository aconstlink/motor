...
namespace motor
{
    namespace controls
    {
        namespace components
        {
            ...
            static motor::string_t to_string( motor::controls::components::vibrator_state const s ) noexcept
            {
                using bs_t = motor::controls::components::vibrator_state ;
            ...
            private:
                ...
                motor::controls::components::vibrator_state _s ;
                float_t _value = 0.0f ;
            ...
            public:
                ...
                {
                    _s = rhv._s ; rhv._s = motor::controls::components::vibrator_state::none ;
                    _value = rhv._value ;
                }
            ...
            public:
                ...
                this_ref_t operator = ( motor::controls::components::vibrator_state const s ) noexcept
                {
                    _s = s ;
                    return *this ;
                }
                ...
                {
                    if( _s == motor::controls::components::vibrator_state::on )
                    {
                        _s = motor::controls::components::vibrator_state::running ;
                    }
                    else if( _s == motor::controls::components::vibrator_state::off )
                    {
                        _s = motor::controls::components::vibrator_state::none ;
                    }
                }
            };
