    ...
    namespace controls
    {
        namespace components
        {
            ...
            public:
                ...
                this_ref_t operator = ( motor::controls::components::move_state const ms ) noexcept
                {
                ...
                virtual void_t update( void_t ) noexcept final
                {
                    ...
                    if( _state == motor::controls::components::move_state::moved )
                    {
                        _state = motor::controls::components::move_state::moving ;
                    }
                    else if( _state == motor::controls::components::move_state::unmoved )
                    {
                        _state = motor::controls::components::move_state::none ;
                    }
                }
            };
            motor_typedef( point ) ;
