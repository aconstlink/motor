    ...
    namespace controls
    {
        namespace components
        {
            ...
            public:
                ...
                this_ref_t operator = ( motor::controls::components::stick_state const v ) noexcept
                {
                    _ss = v ;
                    return *this ;
                }
                ...
                motor::controls::components::stick_state state( void_t ) const noexcept { return _ss ; }

                virtual void_t update( void_t ) noexcept final
                {
                    if( _ss == motor::controls::components::stick_state::tilted )
                    {
                        _ss = motor::controls::components::stick_state::tilting ;
                    }
                    else if( _ss == motor::controls::components::stick_state::untilted )
                    {
                        _ss = motor::controls::components::stick_state::none ;
                    }
                }
            };
            motor_typedef( stick ) ;
