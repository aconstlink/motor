...
namespace motor
{
    namespace device
    {
        namespace layouts
        {
            ...
            private:
                ...
                static void_t init_components( this_t::this_device_ref_t dev )
                {
                    ...
                    // buttons
                    dev.add_input_component<motor::device::components::button_t>() ; // jump
                    ...
                    dev.add_input_component<motor::device::components::button_t>() ;
                    dev.add_input_component<motor::device::components::button_t>() ;
                    dev.add_input_component<motor::device::components::button_t>() ; // action_i

                    // sticks
                    dev.add_input_component<motor::device::components::stick_t>() ; // movement
                    dev.add_input_component<motor::device::components::stick_t>() ; // aim
                   

                    // outputs
                    dev.add_output_component<motor::device::components::vibrator_t>() ; // vibration_a
                    dev.add_output_component<motor::device::components::vibrator_t>() ; // vibration_b
                }

            private:

                motor::device::components::button_ptr_t comp_button( this_t::input_component const ic ) const noexcept
                {
            ...
            public: // is
                ...
                bool_t is( this_t::button const b, motor::device::components::button_state const bs, float_out_t value ) const noexcept
                {
                    motor::device::components::button_ptr_t btn = nullptr ;
                ...
                bool_t is( this_t::directional const d, motor::device::components::stick_state const bs, motor::math::vec2f_out_t value ) const noexcept
                {
                    using comp_t = motor::device::components::stick_t ;
                    comp_t * comp = nullptr ;
            ...
            public: // vibration
                ...
                bool_t is( this_t::vibration const b, motor::device::components::vibrator_state const bs, float_out_t value ) const noexcept
                {
                    using comp_t = motor::device::components::vibrator_t ;
                    comp_t* comp = nullptr ;
        ...
        motor_typedefs( motor::device::device_tpl< motor::device::layouts::game_controller_t>, game_device ) ;
    }
}