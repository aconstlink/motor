    ...
    namespace device
    {
        namespace layouts
        {
            ...
            public:
                ...
                motor_typedefs( motor::device::components::key< ascii_key >, ascii_component ) ;
            ...
            private:
                ...
                {
                    using key_t = motor::device::components::key<this_t::ascii_key> ;
            ...
            public:
                ...
                this_ref_t set_state( this_t::ascii_key const k, motor::device::components::key_state const ks ) noexcept
                {
                ...
                motor::device::components::key_state get_state( this_t::ascii_key const k ) const noexcept
                {
        ...
        motor_typedefs( motor::device::device_tpl< motor::device::layouts::ascii_keyboard>, ascii_device ) ;
        motor_typedefs( motor::device::device_tpl< motor::device::layouts::ascii_keyboard>, ascii_keyboard_device ) ;
    }
}
