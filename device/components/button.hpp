...
namespace motor
{
    namespace device
    {
        namespace components
        {
            ...
            static motor::string_t to_string( motor::device::components::button_state const s ) noexcept
            {
                using bs_t = motor::device::components::button_state ;
            ...
            private:
                ...
                motor::device::components::button_state _bs = button_state::none ;
                float_t _value = 0.0f ;
            ...
            public:
                ...
                {
                    _bs = rhv._bs ; rhv._bs = motor::device::components::button_state::none ;
                    _value = rhv._value ; 
                }
            ...
            public:
                ...
                {
                    if( _bs == motor::device::components::button_state::pressed )
                    {
                        _bs = motor::device::components::button_state::pressing ;
                    }
                    else if( _bs == motor::device::components::button_state::released )
                    {
                        _bs = motor::device::components::button_state::none ;
                    }
                }
            };
