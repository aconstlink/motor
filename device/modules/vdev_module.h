...
namespace motor
{
    namespace device
    {
        ...
        class MOTOR_DEVICE_API vdev_module : public imodule
        {
            ...
            struct data
            {
                ...
                motor::device::game_device_mtr_t dev ;
            };
        ...
        public:
            ...
            void_t check_devices( motor::device::imodule_mtr_t ) noexcept ;

        private:

            void_t init_controller_1( motor::device::imodule_mtr_t ) noexcept ;
        } ;
