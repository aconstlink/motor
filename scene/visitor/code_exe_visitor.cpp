...
//*********************************************************************
motor::scene::result code_exe_visitor::visit( motor::scene::camera_node_ptr_t nptr ) noexcept 
{
    return this_t::visit( motor::scene::node_ptr_t(nptr) )  ;
}

//*********************************************************************
motor::scene::result code_exe_visitor::visit( motor::scene::trafo3d_node_ptr_t nptr ) noexcept
{
    return this_t::visit( motor::scene::node_ptr_t(nptr) )  ;
}

//*********************************************************************
motor::scene::result code_exe_visitor::post_visit( motor::scene::trafo3d_node_ptr_t, motor::scene::result const ) noexcept
{
    return motor::scene::result::ok ;
}
