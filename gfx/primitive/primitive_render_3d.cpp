...
void_t primitive_render_3d::init( motor::string_cref_t name, motor::graphics::async_views_t asyncs ) noexcept 
{
    _name = name ;
    _asyncs = asyncs ;

    _lr = motor::gfx::line_render_3d_res_t( motor::gfx::line_render_3d_t() ) ;
    _lr->init( name + ".line_render", _asyncs ) ;

    _tr = motor::gfx::tri_render_3d_res_t( motor::gfx::tri_render_3d_t() ) ;
