...
void_t line_render_2d::init( motor::string_cref_t name, motor::graphics::async_views_t asyncs ) noexcept 
{
    _name = name ;
    _asyncs = asyncs ;
    ...
    // geometry configuration
    {
        ...
        motor::graphics::geometry_object_res_t geo = motor::graphics::geometry_object_t( name + "_lines",
...
void_t line_render_2d::draw( size_t const l, motor::math::vec2f_cref_t p0, motor::math::vec2f_cref_t p1, motor::math::vec4f_cref_t color ) noexcept
{
    {
