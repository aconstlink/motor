...
#endif
    void_t draw_circle( motor::math::mat3f_cref_t, motor::math::vec3f_cref_t p0, float_t const r,
        motor::math::vec4f_cref_t color, motor::math::vec4f_cref_t border_color,
