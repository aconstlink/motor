...
//*********************************************
generic_camera::this_ref_t generic_camera::make_orthographic( float_t const w, float_t const h, float_t const n,
                                                              float_t const f ) noexcept
{
    _proj_matrix = motor::math::m3d::orthographic< float_t >::create( w, h, n, f );
...
{
    motor::math::m3d::perspective< float_t >::create_by_fovv_aspect( fov, w / h, n, f, _proj_matrix );
...
//*********************************************
generic_camera::this_t generic_camera::create_orthographic( float_t const w, float_t const h, float_t const n,
                                                            float_t const f ) noexcept
{
...
//*********************************************
generic_camera::this_ref_t generic_camera::look_at( motor::math::vec3f_cref_t pos, motor::math::vec3f_cref_t up,
                                                    motor::math::vec3f_cref_t at ) noexcept
{
    motor::math::mat4f_t m;
    motor::math::m3d::camera_util< float_t >::create_lookat( pos, up, at, m );
...
{
    return motor::math::m3d::camera_util< float_t >::get_pos_from_camera_matrix( _cam_matrix );
}

generic_camera::this_cref_t generic_camera::get_position( vec3_ref_t pos ) const noexcept
{
    pos = motor::math::m3d::camera_util< float_t >::get_pos_from_camera_matrix( _cam_matrix );
    return *this;
}

generic_camera::vec3_t generic_camera::get_direction( void_t ) const noexcept
{
    return motor::math::m3d::camera_util< float_t >::get_dir_from_camera_matrix( _cam_matrix );
}

generic_camera::this_cref_t generic_camera::get_direction( vec3_ref_t dir ) const noexcept
{
    dir = motor::math::m3d::camera_util< float_t >::get_dir_from_camera_matrix( _cam_matrix );
    return *this;
}
...
generic_camera::vec3_t generic_camera::get_up( void_t ) const noexcept
{
    ...
    return motor::math::m3d::camera_util< float_t >::get_up_from_camera_matrix( _cam_matrix );
}

generic_camera::this_cref_t generic_camera::get_up( vec3_ref_t up ) const noexcept
{
    up = motor::math::m3d::camera_util< float_t >::get_up_from_camera_matrix( _cam_matrix );
    return *this;
}
...
generic_camera::vec3_t generic_camera::get_right( void_t ) const noexcept
{
    ...
    return motor::math::m3d::camera_util< float_t >::get_right_from_camera_matrix( _cam_matrix );
}

generic_camera::this_cref_t generic_camera::get_right( vec3_ref_t right ) const noexcept
{
    right = motor::math::m3d::camera_util< float_t >::get_right_from_camera_matrix( _cam_matrix );
    return *this;
}
...
{
    auto const nl = motor::math::m3d::detail::perspective_projection< float_t >::get_half_length_for( _fov, nf.x() );
    auto const fl = motor::math::m3d::detail::perspective_projection< float_t >::get_half_length_for( _fov, nf.y() );
...
generic_camera::ray3_t generic_camera::create_ray_norm( vec2_cref_t norm_pos ) const noexcept
{
    if( _projection_mode == projection_type::perspective )
    {
        ...
        return ray3_t( this_t::get_position(),
                       _cam_matrix * vec3_t( norm_pos * vec2_t( w, h ) * 0.5f, 1.0f ).normalize() );
    }
