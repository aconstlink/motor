    ...
    void_t init( motor::string_cref_t rt_name ) noexcept
    {
        ...
        // shaders for post process
        {
                ...
                config gfx.postprocess.stage.tone_map.reinhardt
                {
                    ...
                    pixel_shader
                    {
                        ...
                        void main()
                        {
                            ...
                            vec3_t tone_mapped =  col.xyz / ( col.xyz + reinhardt_offset ) ; 
            ...
            // variable sets
            {
                ...
                {
                    auto * var = vars.data_variable< motor::math::vec3f_t >( "reinhardt_offset" );
...

                {
                    ...
                    motor::property::add_is_property< motor::math::vec3f_t >( "reinhardt_offset",
                        _brg->borrow_inputs()->borrow( "reinhardt_offset" ), ps );

                    {
                        auto * prop = ps.borrow_property< is_vec3f_t >( "reinhardt_offset" );
